...
class BaseTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.collection1 = ModerationCollection.objects.create(author=cls.user, name='Collection 1', workflow=cls.wf1)
        cls.collection2 = ModerationCollection.objects.create(author=cls.user, name='Collection 2', workflow=cls.wf2)
        cls.collection3 = ModerationCollection.objects.create(author=cls.user, name='Collection 3', workflow=cls.wf3)
